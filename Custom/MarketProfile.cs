...
namespace cAlgo
{
    ...
    public class MarketProfile : Indicator
    {
        ...
        [Output("Developing POC 1", LineColor = "Magenta", LineStyle = LineStyle.Solid, PlotType = PlotType.DiscontinuousLine, Thickness = 5)]
        public IndicatorDataSeries DevelopingPOC_1 { get; set; }

        [Output("Developing POC 2", LineColor = "Magenta", LineStyle = LineStyle.Solid, PlotType = PlotType.DiscontinuousLine, Thickness = 5)]
