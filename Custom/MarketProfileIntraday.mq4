...
input session_period Session                 = Intraday;
...
input int            PointMultiplier          = 5;      // PointMultiplier: higher value = fewer objects. 0 - adaptive.
...
input intraday_session_size  IntradaySessionSize        = Session4Hours;
